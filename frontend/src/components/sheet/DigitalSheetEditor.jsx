...
export function DigitalSheetEditor({ character, token, onSaved }) {
  ...
  return (
    <div className="flex h-full flex-col overflow-hidden bg-void">
      <div className="shrink-0 border-b border-zinc-800 bg-zinc-950/80 px-4 py-2">
        <div className="flex w-full flex-wrap items-center justify-between gap-3">
          <p className="text-xs font-mono text-zinc-600 lg:text-sm">
          ...
          <div className="flex flex-wrap items-center gap-3">
            ...
            <button
              ...
              onClick={() => handleSave()}
              className="inline-flex items-center gap-1.5 border border-neon-cyan px-4 py-2 text-xs font-black uppercase text-neon-cyan hover:bg-neon-cyan/10 disabled:opacity-40"
            >
      ...
      <div className="min-h-0 flex-1 overflow-y-auto px-4 py-4 lg:px-8 xl:px-10 2xl:px-12">
